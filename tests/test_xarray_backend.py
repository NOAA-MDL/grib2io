...
class TestIsIcechunkStore:
    ...
    def test_detects_icechunk_store_instance(self):
        ...
        # Create a mock object that looks like an IcechunkStore
...
class TestImportErrors:
    ...
    def test_ensure_kerchunk_error_message(self):
        ...
        with mock.patch.dict("sys.modules", {"fsspec": None}):
            with pytest.raises(
                ImportError,
                match="pip install grib2io\\[kerchunk\\]",
            ):
                _ensure_kerchunk()
    ...
    def test_ensure_icechunk_error_message(self):
        ...
        with mock.patch.dict("sys.modules", {"icechunk": None}):
            with pytest.raises(
                ImportError,
                match="pip install grib2io\\[icechunk\\]",
            ):
                _ensure_icechunk()
...
# ===========================================================================
# Existing xarray backend tests (preserved)
# ===========================================================================
