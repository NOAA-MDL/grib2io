...
section4_eval = {
    "totAsy340": np.array([0, 48, 20, 104, 62000, 0, 6, 20, 0, 0, 7, 9, 338, 9, 342, 2, 0, 96, 0, 0, 1, 0, 10, 0, 0, 255, 0, 0]),
    "totSSA340": np.array([0, 48, 20, 103, 62000, 0, 6, 20, 0, 0, 7, 9, 338, 9, 342, 2, 0, 96, 0, 0, 1, 0, 10, 0, 0, 255, 0, 0]),
    "totAOD440": np.array([0, 48, 20, 102, 62000, 0, 6, 20, 0, 0, 7, 9, 430, 9, 450, 2, 0, 96, 0, 0, 1, 0, 10, 0, 0, 255, 0, 0]),
    "totAOD550": np.array([0, 48, 20, 102, 62000, 0, 6, 20, 0, 0, 7, 9, 545, 9, 565, 2, 0, 96, 0, 0, 1, 0, 10, 0, 0, 255, 0, 0]),
    "totScatAOD550": np.array([0, 48, 20, 112, 62000, 0, 6, 20, 0, 0, 7, 9, 545, 9, 565, 2, 0, 96, 0, 0, 1, 0, 10, 0, 0, 255, 0, 0]),
    "duAOD550": np.array([0, 48, 20, 102, 62001, 0, 6, 20, 0, 0, 7, 9, 545, 9, 565, 2, 0, 96, 0, 0, 1, 0, 10, 0, 0, 255, 0, 0]),
    "duScatAOD550": np.array([0, 48, 20, 112, 62001, 0, 6, 20, 0, 0, 7, 9, 545, 9, 565, 2, 0, 96, 0, 0, 1, 0, 10, 0, 0, 255, 0, 0]),
    "ssAOD550": np.array([0, 48, 20, 102, 62008, 0, 6, 20, 0, 0, 7, 9, 545, 9, 565, 2, 0, 96, 0, 0, 1, 0, 10, 0, 0, 255, 0, 0]),
    "ssScatAOD550": np.array([0, 48, 20, 112, 62008, 0, 6, 20, 0, 0, 7, 9, 545, 9, 565, 2, 0, 96, 0, 0, 1, 0, 10, 0, 0, 255, 0, 0]),
    "so4AOD550": np.array([0, 48, 20, 102, 62006, 0, 6, 20, 0, 0, 7, 9, 545, 9, 565, 2, 0, 96, 0, 0, 1, 0, 10, 0, 0, 255, 0, 0]),
    "so4ScatAOD550": np.array([0, 48, 20, 112, 62006, 0, 8, 70, 0, 0, 7, 9, 545, 9, 565, 2, 0, 96, 0, 0, 1, 0, 10, 0, 0, 255, 0, 0]),
    "omAOD550": np.array([0, 48, 20, 102, 62010, 0, 6, 20, 0, 0, 7, 9, 545, 9, 565, 2, 0, 96, 0, 0, 1, 0, 10, 0, 0, 255, 0, 0]),
    "omScatAOD550": np.array([0, 48, 20, 112, 62010, 0, 8, 70, 0, 0, 7, 9, 545, 9, 565, 2, 0, 96, 0, 0, 1, 0, 10, 0, 0, 255, 0, 0]),
    "bcAOD550": np.array([0, 48, 20, 102, 62009, 0, 6, 20, 0, 0, 7, 9, 545, 9, 565, 2, 0, 96, 0, 0, 1, 0, 10, 0, 0, 255, 0, 0]),
    "bcScatAOD550": np.array([0, 48, 20, 112, 62009, 0, 8, 70, 0, 0, 7, 9, 545, 9, 565, 2, 0, 96, 0, 0, 1, 0, 10, 0, 0, 255, 0, 0]),
    "totAOD645": np.array([0, 48, 20, 102, 62000, 0, 6, 20, 0, 0, 7, 9, 620, 9, 670, 2, 0, 96, 0, 0, 1, 0, 10, 0, 0, 255, 0, 0]),
    ...
    "ss_pm25_colmd": np.array([0, 48, 20, 1, 62008, 0, 7, 25, 0, 0, 255, 0, 0, 0, 0, 2, 0, 96, 0, 0, 1, 0, 10, 0, 0, 255, 0, 0]),
    "bc_pm236_colmd": np.array([0, 48, 20, 1, 62009, 0, 10, 236, 0, 0, 255, 0, 0, 0, 0, 2, 0, 96, 0, 0, 1, 0, 10, 0, 0, 255, 0, 0]),
    "om_pm424_colmd": np.array([0, 48, 20, 1, 62010, 0, 10, 424, 0, 0, 255, 0, 0, 0, 0, 2, 0, 96, 0, 0, 1, 0, 10, 0, 0, 255, 0, 0]),
    "so4_pm25_colmd": np.array([0, 48, 20, 1, 62006, 0, 7, 25, 0, 0, 255, 0, 0, 0, 0, 2, 0, 96, 0, 0, 1, 0, 10, 0, 0, 255, 0, 0]),
}
