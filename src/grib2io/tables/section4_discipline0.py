...
'51':['Total Column Water (Vertically Integrated Total Water (Vapor + Cloud Water/Ice))','kg m-2','TCWAT'],
...
'78':['Total Column Integrated Water (all components including precipitation)','kg m-2','TCOLWA'],
...
'233':['Effective Layer Bulk Shear Magnitude (Inflow Base to 50% of EL)','kt','ESHR'],
'234':['U Component Effective Layer Bulk Shear (Inflow Base to 50% of EL)','kt','UESH'],
'235':['V Component Effective Layer Bulk Shear (Inflow Base to 50% of EL)','kt','VESH'],
...
'19':['Loss Rate Due to Reaction with Hydroxyl Radical (OH)','kg kg-1 s-1','LRATEOH'],
