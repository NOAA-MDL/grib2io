...
class Grib2ioDataArray:
    ...
    def interp_to_stations(self, method: typing.Union[str, int], calls: typing.Sequence[str], lats: typing.Sequence[float], lons: typing.Sequence[float], method_options: typing.Optional[typing.List[int]]=None, num_threads: int=1) -> xr.DataArray:
        """
