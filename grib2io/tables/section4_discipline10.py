...
'93-191':['Reserved','unknown','unknown'],
...
'13':['Net upward water flux','kg m-2s-1','unknown'],
'14':['Eastward surface water velocity','m s-1','unknown'],
'15':['Northward surface water velocity','m s-1','unknown'],
'16':['x-component of surface water velocity','m s-1','unknown'],
'17':['y-component of surface water velocity','m s-1','unknown'],
'18':['Heat flux correction','W m-2','unknown'],
'19':['Sea surface height tendency due to parameterization','m s-1','unknown'],
'20':['Deviation of sea level from mean with inverse barometer correction','m','unknown'],
...
'31':['Fresh Water Flux Correction','kg m-2s-1','FWFC'],
'32':['Virtual Salt Flux into Sea Water','g kg m-2s-1','VSFSW'],
'33':['Virtual Salt Flux Correction','g kg m-2s-1','VSFC'],
'34':['Sea Water Temperature Tendency due to Newtonian Relaxation','K s-1','SWTTNR'],
'35':['Sea Water Salinity Tendency due to Newtonian Relaxation','g kg m-2s-1','SWSTNR'],
'36':['Sea Water Temperature Tendency due to Parameterization','K s-1','SWTTP'],
'37':['Sea Water Salinity Tendency due to Parameterization','g kg m-2s-1','SWSTP'],
'38':['Eastward Sea Water Velocity Tendency Due To Parameterization','m-2s-1','ESWVP'],
'39':['Northward Sea Water Velocity Tendency Due To Parameterization','m-2s-1','NSWVP'],
'40':['Sea Water Temperature Tendency Due to Direct Bias Correction','K s-1','SWTTBC'],
'41':['Sea Water Salinity Tendency due to Direct Bias Correction','g kg m-2s-1','SWSTBC'],
'42-191':['Reserved','unknown','unknown'],
'192-254':['Reserved for Local Use','unknown','unknown'],
