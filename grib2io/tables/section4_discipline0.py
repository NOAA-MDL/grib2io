...
'6':['Time Integrated Air Concentration of Cesium Pollutant (See Note 1)','Bq s m-3','TIACCP'],
'7':['Time Integrated Air Concentration of Iodine Pollutant (See Note 1)','Bq s m-3','TIACIP'],
'8':['Time Integrated Air Concentration of Radioactive Pollutant (See Note 1)','Bq s m-3','TIACRP'],
'9':['Reserved','unknown','unknown'],
'10':['Air Concentration (See Note 3)','Bq m-3','AIRCON'],
'11':['Wet Deposition','Bq m-2','WETDEP'],
'12':['Dry Deposition','Bq m-2','DRYDEP'],
'13':['Total Deposition (Wet + Dry)','Bq m-2','TOTLWD'],
'14':['Specific Activity Concentration (See Note 3)','Bq kg-1','SACON'],
...
'30':['Eddy Dissipation Parameter (See Note 3)','m2/3 s-1','EDPARM'],
...
'60':['Aerosol Specific Number Concentration (See Note 2)','kg-1','ASNCON'],
