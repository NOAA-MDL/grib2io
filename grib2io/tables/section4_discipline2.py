...
'3':['Parameter deprecated - use another parameter instead.','unknown','unknown'],
'4':['Vegetation','%','VEG'],
...
'22':['Parameter deprecated - use another parameter instead.','unknown','unknown'],
...
'239':['Soil Surface Evaporation','SOILSE','unknown'],
...
table_4_2_2_5  = {
'0':['Glacier Cover (see Note)','Proportion','GLACCOV'],
