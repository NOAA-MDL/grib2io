...
'16':['Spread component (as defined by the US Forest Service National Fire Danger Rating System)','Numeric','DRFACT'],
'17':['Burning Index (as defined by the Australian forest service)','Numeric','SPRDCOMP'],
