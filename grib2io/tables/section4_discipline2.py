...
'16':['Drought Factor (as defined by the Australian forest service)','Numeric','DRFACT'],
'17':['Spread component (as defined by the Australian forest service)','Numeric','SPRDCOMP'],
